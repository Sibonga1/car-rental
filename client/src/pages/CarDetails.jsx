...
const CarDetails = () => {
  ...
  // Fetch the car details based on the ID from the dummy data
  useEffect(() => {
    setCar(dummyCarData.find((car) => car._id === id));
  }, [id]);
  // Render the car details if the car is found, otherwise show a loading message
  return car ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <input type="date" className="border-borderColor px-3 py-2 rounded-lg" required
